...
//            System.out.println(obj.getDate());
    ...
    public void testJackson(){
        long start = System.currentTimeMillis();
        BeanObj obj = com.wind.json.jackson.JsonUtil.toBean(jsonStr2, BeanObj.class);
        System.out.println(obj != null ? obj.getDate() : null);
        System.out.println(com.wind.json.jackson.JsonUtil.toJson(obj));
        long end = System.currentTimeMillis();
        System.out.println(end - start);
    }
    ...
    public void testJackson2(){
        long start = System.currentTimeMillis();
        for(int i = 0; i < count; i++){
            BeanObj obj = com.wind.json.jackson.JsonUtil.toBean(jsonStr, BeanObj.class);
//            System.out.println(obj != null ? obj.getDate() : null);
        }
        long end = System.currentTimeMillis();
        System.out.println(end - start);
        long start2 = System.currentTimeMillis();
        list.forEach(com.wind.json.jackson.JsonUtil::toJson);
        long end2 = System.currentTimeMillis();
        System.out.println(end2 - start2);
    }
    ...
    public void testFastjson(){
        long start = System.currentTimeMillis();
        BeanObj obj = com.wind.json.fastjson.JsonUtil.toBean(jsonStr, BeanObj.class);
        System.out.println(obj.getDate());
        System.out.println(com.wind.json.fastjson.JsonUtil.toJson(obj, false));
        long end = System.currentTimeMillis();
        System.out.println(end - start);
    }
...
//            System.out.println(obj.getDate());
        ...
        System.out.println(end - start);
        long start2 = System.currentTimeMillis();
        list.forEach(obj -> com.wind.json.fastjson.JsonUtil.toJson(obj, false));
        long end2 = System.currentTimeMillis();
        System.out.println(end2 - start2);
    }
